...
class PurchaseOkSheet extends StatelessWidget {
  PurchaseOkSheet({Key? key, required this.shortPants}) : super(key: key);
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  H1(
                    text: translate("_sheets._purchase_ok_sheet.title"),
                  ...
                  P(
                    text: translate("_sheets._purchase_ok_sheet.text"),
                    color: AppColors.shortPantsDarkColor(shortPants),
                  ),
                  const SizedBox(
                    height: 16,
                  ...
                  CustomButton(
                    text: translate("_sheets._purchase_ok_sheet.close"),
